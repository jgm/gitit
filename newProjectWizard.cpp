...
/*
 TODO list
- implement NewProjectWizard::nextID() const
...
void NewProjectWizard::createGetRemotePath()
{
...
void NewProjectWizard::createGetLocalDirectory()
{
...
void NewProjectWizard::createEndNew()
{
...
void NewProjectWizard::getPathToLocalDirectory()
{
    QFileDialog dialog(this);
    dialog.setFileMode(QFileDialog::Directory);
    dialog.setViewMode(QFileDialog::Detail);
...
void NewProjectWizard::displayHiddenComment(int index)
{
    if(index == 0)
    {
        userRemotePath->setText("username/projectName");
